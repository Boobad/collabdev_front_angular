...
export class AdminService {
  ...
  listPendingProjects(params?: { page?: number; size?: number }): Observable<Page<Project>> {
    ...
    return this.http.get<Page<Project>>(`${this.base}/projects/validation`, { params: p })
  }
  ...
  listBadges(params?: { page?: number; size?: number }): Observable<Page<Badge>> {
    const p = new HttpParams({ fromObject: toParams(params) })
    return this.http.get<Page<Badge>>(`${this.base}/badges`, { params: p })
  }
  ...
  listUsers(params?: { page?: number; size?: number; q?: string; role?: string }): Observable<Page<User>> {
    const p = new HttpParams({ fromObject: toParams(params) })
    return this.http.get<Page<User>>(`${this.base}/users`, { params: p })
  }
